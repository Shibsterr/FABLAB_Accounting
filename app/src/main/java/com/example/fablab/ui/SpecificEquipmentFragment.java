                            ...
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                if (name != null && name.equals(equipmentName)) {
                                    ...
                                    mainHandler.post(() -> {
                                        ...
                                        roomNumberText.setText(getString(R.string.room, roomNumber));
                        ...
                        executor.execute(() -> {
                            if (dataSnapshot.exists()) {
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    mainHandler.post(() -> stockbtn.setOnClickListener(v -> {
                                        NavController navController = Navigation.findNavController(v);
                                        navController.navigate(R.id.action_specificEquipmentFragment_to_specStockEquipmentFragment, bundle);
                                    }));
                                            ...
                                            executor.execute(() -> {
                                                if (dataSnapshot.exists()) {
                                                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                                        ...
                                                        String description = snapshot.child("Description").getValue(String.class);
                                                        String imageUrl = snapshot.child("Attēls").getValue(String.class);
                                                        String roomNumber = snapshot.child("Telpa").getValue(String.class);
